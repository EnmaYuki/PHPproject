...
<body>
        ...
        <div class="postoverlay">
            ...
            <form action="forum_post.php" method="post" enctype="multipart/form-data" id="form">
                <div class="form-group col-11">
                    ...
                    <textarea id="newcomment" rows="10" class="col-12" name="newcomment" placeholder="Enter text"
    ...
    <div class="row col-9 row-cols-sm-1"
        style="margin:auto; font-size: 16px!important; margin-top: 5rem; margin-bottom: 10rem;">
        <div style="margin-bottom: 2rem;" id="auto-create">
            <div class="misc row" style="height:5rem;">


                <div class="col-1 d-none d-sm-none d-md-block center ma"
                    style="border-right:2px solid #e8e8e8; height: 3rem;">
